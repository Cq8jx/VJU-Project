...
2.  教科の割り当て
    ...
    d)  基礎コンピュータサイエンスの授業は工科大学と自然科学大学で教えられます。
...
ユニットの学年課題で学生の科学研究活動計画を立てます。
    b)  ユニットの科学研究トピック、プロジェクト、その他の科学活動に関連して学生の科学研究を実施します。学生が研究に参加したり、研究グループのメンバーになったり、科学技術活動に参加したりするための条件を整えます。
    c)  学生の科学会議を組織し、学生の研究作品を評価、分類、および表彰します。
    d) 学生科学クラブを設立し、科学テーマ別活動を組織します。
...
以下の違反行為を行った者には、懲戒処分または強制退学処分が適用されます。
    ...
    e)  点数を上げたり下げたりするために学生の答案を訂正または追加すること。
    e)  試験用紙、試験採点記録、成績簿の点数を訂正または歪曲すること。
    f)  学生の試験または試験点数を交換すること。
...
1.  研修プログラムを修了した学生は、以下の条件を満たしていれば卒業対象となります。
    ...
    d)  本規則第12条第3項に規定する外国語能力レベルに達していること。
