...
2.  単語の説明
    ...
    d)  卒業証書付録とは、学習者に関する情報と、研修ユニットが学習者に付与した学習成果を、VNU
        の対応する研修レベルの卒業証書とともに示す文書です。 d) VNU
...
1.  経営原則
    ...
    d)  卒業証書、証明書、認証書の発行および使用におけるすべての不正行為は固く禁止されます。d)
        卒業証書、証明書、認証書の発行における公開性と透明性を確保します。
2.  卒業証書、証明書、認証書の発行を管理する権限の分散化、委任
    ...
    d)  証明書およびその他の認証を授与するための研修および育成活動について：研修ユニットは、管理、開発、プログラムの発行、研修の組織、育成、テスト/試験、評価、証明書および認証の授与、およびその他の関連コンテンツに関する規則を発行するものとする。研修および育成プログラムの内容は、国防、安全保障または公共の利益を害してはならず、宗教を宣伝したり歴史を歪曲したりしてはならず、ベトナムの文化、倫理、慣習に悪影響を与えてはならない。ユニットの責任者は、ユニットが主催する研修および育成プログラムを修了した学習者に証明書および認証を決定および授与するものとする。 d)
        VNUテストセンターが主催する能力評価テストの受験者に付与される認証は、VNUが発行するVNUの高校生向け能力評価テスト規則に従って実施されるものとする。
...
4.  研修ユニットの卒業証書、証明書、認定証の管理におけるその他の責任
    ...
    d)  関係機関、組織、個人からの正当な要請に応じて、卒業証書、証明書、認証書の真正性を検証する。d)
        本規則第 4
        章の規定に従って、卒業証書、証明書、認証書に記載されている内容を編集する。
    e)  本規則第 18
        条に従って卒業証書、証明書、認証を取り消し、取り消す。
    f)  卒業証書、証明書、認定書および関連記録を保存および保管するための施設と防火設備を確保します。
...
1.  博士号取得の場合
    ...
    d)  「生年月日:...時...」欄:
        学位取得者の生年月日と出生地(学位授与時の省または中央直轄市レベルの行政単位)を記入する。海外出生のベトナム人の場合は、出生証明書に基づいて出生地を記入する。ベトナム国籍を持たない学位取得者の場合は、国籍(入学記録による)を記入する。d)
        「ハノイ、年...月...日」欄:
    ...
    f)  「学位の認定および卒業証書の授与に関する決定」セクション：VNUまたは卒業証書授与権限を持つ訓練ユニットによる学位の認定に関する決定の署名番号と日付、月、年を記録します。
    g)  「冊子番号」欄：訓練部隊が作成したオリジナルの卒業証書冊子の番号を記録し、情報を記入し、部隊で永久に保存および保管する（本規則の付録XIVの形式に従って）。
2.  修士号取得の場合
    ...
    d)  「名」欄：証明書を受け取る人の姓、ミドルネーム（ある場合）、名、性別を記入します（性別は姓の前に付け、Mr./Ms.と記入します）。証明書を受け取る人の氏名は、Times
        New
        Romanフォント、Arialフォント、または明瞭で読みやすいフォントで記入します。姓、ミドルネーム（ある場合）、名の最初の文字を大文字にします。英語の氏名は、対応するベトナム語フォントでアクセントなしで印刷し、姓、ミドルネーム（ある場合）、名の最初の文字を大文字にします。適切なフォントサイズを使用し、証明書の文字とのバランスを保ちます。 d)
        「出生日：...時...」欄：証明書を受け取る人の生年月日と出生地（証明書交付時の省または中央直轄市レベルの行政単位）を記入します。国外で生まれたベトナム人の場合は、出生地は出生証明書に従って記入します。ベトナム国籍を持たない証明書を受け取る人は、国籍を記入してください（入学プロファイルに従って）。
    e)  「ハノイ、年月日」のセクション：VNUのディレクターまたは学長が卒業証書に署名した年月日を記録します。
    f)  「ディレクター」または「プリンシパル」セクションは、VNU
    ...
    g)  「学位の認定および卒業証書の授与に関する決定」セクション：VNUまたは卒業証書の授与権限を持つ訓練ユニットによる卒業認定の決定の署名番号と日付、月、年を記録します。
    h)  「冊子番号」の項：訓練部隊が作成したオリジナルの卒業証書冊子の番号を記録し、情報を記入し、部隊で永久に保存し保管する（本規則の付録XIIIの様式に従って）。
3.  学士号、エンジニア、医師、薬剤師
    a)  「校長...レベル」セクション：研修ユニットの名前を記録します（付録Iに従って）。
    ...
    f)  「生年月日：...時...」欄：証明書所持者の生年月日および出生地（証明書交付時の省または中央直轄市の行政単位）を記入します。海外出生のベトナム人の場合は、出生証明書に基づいて出生地を記入します。ベトナム国籍を持たない証明書所持者の場合は、国籍（入国書類に基づいて）を記入します。
    ...
    j)  「冊子番号」欄：訓練部隊が作成したオリジナルの卒業証書冊子の番号を記録し、情報を記入し、部隊で永久に保存および保管する（本規則の付録XIIの様式に従って）。
...
2.  訓練ユニット長の責任
    ...
    d)  発行された白紙証明書および印刷された白紙証明書を保管する際の施設、設備、安全、火災および爆発の防止を確保する。d)
        白紙サンプルを承認し、単位の白紙証明書の番号、記号、偽造防止スタンプの設定を規制する。白紙証明書の印刷、管理、保管、発行、使用の検査を組織する。白紙証明書および証明書に印刷される内容に責任を負う。
...
1.  以下の事項に違反した場合、卒業証書、証明書、資格証書は取り消し、取り消しとなり、卒業認定決定・証明書発行決定も取り消されます。
    ...
    c)  資格のない者に付与される。
    d)  権限のない者によって発行されたもの。d)
        消去または変更されたもの。
    e)  卒業証書、証明書、認定書を他の人に使用させるため。
    f)  卒業証書、証明書、または認証書を発行する管轄当局の過失による場合。
...
1.  研修部門の責任
    ...
    d)  資格と能力のある職員を配置し、規則に従って卒業証書の発行と管理を担当させる。d)
        訓練ユニットにおける卒業証書の保管と卒業証書、証明書、認証書の管理の検査の業務を実行する（必要に応じて関連する機能部門と調整する）。
...
3.  教育訓練省及び関係する国家機関がこの規則の内容と異なる規則を有する場合には、教育訓練省及び関係する国家機関の現行の規則が適用されるものとする。
  ...
  \| 番号 \| 専攻/研修専攻のベトナム語名 \| 専攻/研修専攻の英語名 \| \| :-- \| :--- \| :--- \| \| 1 \| ジャーナリズム \| ジャーナリズム \| \| 2 \| 気候変動と持続可能な開発 \| 気候変動と持続可能な開発 \| \| 3 \| 政治学 \| 政治学 \| \| 4 \| 力学 \| \| 5 \|
  工学力学 \| \| 6 \| 電子通信工学技術 \| \| 7 \| バイオテクノロジー \| バイオテクノロジー \| \| 8 \| ソーシャルワーク \| \| ソーシャルワーク \| \| 9 \| 文化遺産研究 \| \| 10 \| 地質学 \| 地質学 \| \| 11 \| 地理学 \| 地理学 \| \| 12 \| 教育の測定と評価 \|
  教育の測定と評価 \| \| 13 \| 東洋学 \| \| 14 \| 観光 \| 観光 \| \| 15 \| 海洋学 \| 海洋学 \| \| 16 \| シノノム \| シノノム \| \| 17 \| 情報システム \| 情報システム \| \| 18 \| ホーチミン研究 \| ホーチミン研究 \| \| 19 \| 化学 \| 化学 \| \| 20 \|
  気象学と気候学 \| \| 21 \| 土壌科学 \| 土壌科学 \| \| 22 \| コンピュータサイエンス \| コンピュータサイエンス \| \| 23 \| 環境科学 \| \| 24 \| コンピュータサイエンスとエンジニアリング \| コンピュータサイエンスとエンジニアリング \| \| 25 \| 政治経済学 \|
  政治経済学 \| \| 26 \| 国際経済学 \| \| 27 \| 経済と経営 \| 経済と経営 \| \| 28 \| 化学工学 \| 化学工学 \| \| 29 \| 環境工学 \| 環境工学 \| \| 30 \| ソフトウェア工学 \| ソフトウェア工学 \| \| 31 \| 土木工学 \| 土木工学 \| \| 32 \| 国家と法の理論と歴史 \|
  \| 33 \| 歴史 \| 歴史 \| \| 34 \| 法律 \| \| 35 \| 民法と民事訴訟法 \| 民法と民事訴訟法 \| \| 36 \|憲法および行政法 \| 憲法および行政法 \| \| 37 \| 刑法および刑事訴訟法 \| 刑法および刑事訴訟法 \| \| 38 \| 経済法 \| 経済法 \| \| 39 \| 国際法 \| \| 40 \|
  アーカイブ学 \| \| 41 \| 教授理論、方法論、および教育技術 \| \| 42 \| コンピュータネットワークおよびデータ通信 \| \| 43 \| 環境と持続可能な開発 \| \| 44 \| 英語 \| 英語学 \| \| 45 \| 言語学 \| \| 46 \| ロシア語 \| ロシア語学 \| \| 47 \| フランス語 \|
  フランス語学 \| \| 48 \| 中国語学 \| \| 49 \| 人類学 \| \| 50 \| 日本研究 \| \| 51 \| 仏教研究 \| \| 52 \| 土地管理 \| \| 53 \| 教育管理 \| 教育管理 \| \| 54 \| 情報システム管理 \|情報システム管理 \| \| 55 \| 科学技術管理 \| \| 56 \| 経済管理 \| \| 57 \|
  資源と環境の管理 \| \| 58 \| 経営管理 \| \| 59 \| 持続可能な開発とマネジメント \| \| 60 \| 国際研究 \| \| 61 \| 生物学 \| \| 62 \| 英語教師教育 \| \| 63 \| ロシア語教師教育 \| \| 64 \| フランス語教師教育 \| \| 65 \| 中国語教師教育 \| \| 66 \| 金融 - 銀行
  \| 金融 - 銀行 \| \| 67 \| 心理学 \| \| 68 \| 図書館情報学 \| \| 69 \| 水文学 \| 水文学 \| \| 70 \| 情報科学とコンピュータ工学 \| \| 71 \| 数学 \| 数学 \| \| 72 \| 数学とコンピュータサイエンス \| \| 73 \| 応用数学 \| 応用数学 \| \| 74 \| 宗教学 \| \| 75
  \| 哲学 \|哲学 \| \| 76 \| 文学 \| 文学 \| \| 77 \| ナノ材料とデバイス \| \| 78 \| 物理学 \| 物理学 \| \| 79 \| ベトナム研究 \| \| 80 \| 社会学 \| 社会学 \|

  ¹*研修専攻/専門分野の名称がこのリストにまだ含まれていない場合、または現行の規則に従って変更されている場合、専攻/専門分野の名称は、決定の適用可能な効果に従って、プログラムを公布する決定またはプログラムを変更/調整する決定に従って記録されるものとします。*
  --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

### 付録III：修士号を授与できる分野／専門分野一覧²

  -----------------------------------------------------------------------------------------------------------------------------
  STT          研修専攻/専門分野のベトナム語名            研修専攻/分野の英語名                    注記
  ------------ ------------------------------------------ ---------------------------------------- ----------------------------
  1            情報セキュリティ                           情報セキュリティ                         
  ...
  10           メカトロニクス工学技術                     メカトロニクス工学                       

  11           電子・通信工学技術                         電子通信工学                             

  12           環境工学技術                               環境技術                                 専門分野

  13           ナノテクノロジー                           ナノテクノロジー                         専門分野

  14           バイオナノテクノロジー                     バイオナノテクノロジー                   専門分野

  15           バイオテクノロジー                         バイオテクノロジー                       

  16           金融テクノロジー                           金融テクノロジー                         

  17           金融テクノロジーとデジタルビジネス         フィンテックとデジタルビジネス           大学と修士課程の組み合わせ

  18           情報技術                                   情報技術                                 

  19           応用情報技術                               応用情報技術                             大学と修士課程の組み合わせ
  ...
  35           持続可能な科学                             持続可能性科学                           専門分野

  36           土壌科学                                   土壌科学                                 

  37           データサイエンス                           データサイエンス                         専門分野

  38           コンピュータサイエンス                     コンピュータサイエンス                   
  ...
  45           メカトロニクス工学                         メカトロニクス工学                       大学と修士課程の組み合わせ

  46           インフラエンジニアリング                   インフラエンジニアリング                 

  47           産業システム工学と物流                     産業システム工学と物流                   大学と修士課程の組み合わせ

  48           化学工学                                   化学工学                                 

  49           環境工学                                   環境工学                                 

  50           ソフトウェアエンジニアリング               ソフトウェアエンジニアリング             

  51           建設工学                                   土木工学                                 

  52           グローバルリーダーシップ                   グローバルリーダーシップ                 

  53           国家と法の理論と歴史                       国家と法の理論と歴史                     

  54           映画とテレビの理論と歴史                   映画とテレビの理論と歴史                 

  55           歴史                                       歴史                                     

  56           法                                         法                                       

  57           海洋法と海洋管理                           海洋法と海洋管理                         

  58           民法と民事訴訟法                           民法および民事訴訟法                     

  59           憲法と行政法                               憲法と行政法                             

  60           刑法と刑事訴訟                             刑法および刑事訴訟法                     
  ...
  64           コンピュータネットワークとデータ通信       コンピュータネットワークとデータ通信     

  65           眼科                                       眼科                                     

  66           映画とテレビ芸術                           映画とテレビ芸術                         
  ...
  86           科学技術マネジメント                       科学技術マネジメント                     

  87           経済管理                                   経済管理                                 

  88           資源と環境管理                             資源と環境の管理                         

  89           非伝統的なセキュリティガバナンス           非伝統的安全保障の管理                   専門分野

  90           メディア管理                               メディア管理                             

  91           金融機関の経営                             金融機関経営                             

  92           技術管理と事業開発                         テクノロジーと起業家精神のマネジメント   専門分野

  93           経営管理                                   経営管理                                 

  94           国家統治と汚職防止                         国家統治と汚職防止                       
  ...
  103          文学教育学                                 言語学と文学の教師教育                   

  104          生物学教育学                               生物学教師教育                           

  105          英語教育学                                 英語教師教育                             

  106          ロシア語教育学                             ロシア語教師教育                         

  107          フランスの教育学                           フランス語教師教育                       
  ...
  114          スクールカウンセリング                     スクールカウンセリング                   

  115          情報科学 - 図書館                          図書館情報学                             

  116          水文学                                     水文学                                   

  117          コンピュータサイエンスとエンジニアリング   情報科学とコンピュータ工学               

  118          数学                                       数学                                     

  119          数学と情報技術                             数学とコンピュータサイエンス             
...
²*研修専攻/専門分野の名称がこのリストにまだ含まれていない場合、または現行の規則に従って変更されている場合、専攻/専門分野の名称は、決定の適用可能な効果に従って、プログラムを公布する決定またはプログラムを変更/調整する決定に従って記録されるものとします。*
  ...
  ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  \### 付録IV: 学士号を授与するプログラムのリスト³
  ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  \### 付録 V: 工学学位を授与するプロファイルのリスト⁵

  \| 番号 \| 研修専攻のベトナム語名 \| 研修専攻の英語名 \| 注記 \| \| :-- \| :--- \| :--- \| :--- \| \| 1 \| 工学力学 \| \| \| 2 \| 航空宇宙技術 \| 航空宇宙工学 \| \| \| 3 \|
  建設工学技術 \| 土木工学 \| \| \| 4 \| 農業技術 \| 農業技術 \| \| \| 5 \| 食品技術と健康 \| 食品技術と健康 \| \| \| 6 \| スマートで持続可能な農業 \| スマート農業と持続可能性 \|
  \| \| 7 \| メカトロニクス工学 \| メカトロニクス工学 \| 学士および修士 \| \| 8 \| 建設工学 \| 土木工学 \| \| \| 9 \| 制御工学と自動化 \| \| \| 10 \| コンピュータ工学 \|
  コンピュータ工学 \| \| \| 11 \| エネルギー工学 \| エネルギー工学 \| \| \| 12 \| ロボット工学 \| ロボット工学 \| \| \| 13 \| コンピュータネットワークとデータ通信 \|
  コンピュータネットワークとデータ通信 \| \| \| 14 \| 自動化と情報科学 \| \|
...
c)  日付............以降、当該ユニットの共同研修プログラムの学習者に外国パートナーから授与された卒業証書（受領および管理済み）の数（該当する場合）
...
b)
証明書、外国語証明書、ベトナム語証明書、ITアプリケーション証明書、検査官資格、教育資格、専門職称号基準の付与のための試験の組織(管轄当局の許可による):
